...
class AdminTable extends Component {
    ...
    updateTable = function(page) {
        ...
        if(this.props.columns[column_len-1].title!=='操作') {
            let fixed = 'right';
            if(this.props.current_tab === 'Homework' || this.props.current_tab === 'Notices') {
                console.log("fixed: null");
                fixed = null;
            }
            this.props.columns.push(
                {
                    title: '操作', dataIndex: 'action', key: 'action', fixed: fixed, render: (text, record) =>
                        <span>
                        <Button onClick={() => {
...
const table_columns = {
    ...
    'Courses': [
        {title: 'ID', dataIndex: 'id', key: 'id', fixed: 'left'},
        {title: '课堂名称', dataIndex: 'name', key: 'name', fixed: 'left'},
        {title: '课程描述', dataIndex: 'description', key: 'description', width: 150},
        {title: '状态', dataIndex: 'status', key: 'status', width: 150, render: (num) => {
            switch(num) {
    ...
    'Homework': [
        ...
        {title: '作业名称', dataIndex: 'name', key: 'name', width: 150},
        {title: '作业描述', dataIndex: 'description', key: 'description', width: 150},
        {title: '截止日期', dataIndex: 'deadline', key: 'deadline', width: 150, render: (timestamp) => {
    ...
    'Problems': [
        ...
        {title: '创建者', dataIndex: 'user_id', key: 'user_id', width: 150},
    ...
    'Records': [
        {title: 'ID', dataIndex: 'id', key: 'id', fixed: 'left'},
        {title: '提交用户', dataIndex: 'user_id', key: 'user_id', fixed: 'left'},
        {title: '提交时间', dataIndex: 'submit_time', key: 'submit_time', width: 150, render: (time) => {
    ...
    'Notices': [
        ...
        {title: '创建用户', dataIndex: 'user_id', key: 'user_id', width: 150},
