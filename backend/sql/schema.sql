...
INSERT INTO homeworks (name, description, deadline, problems, records) VALUES ('homework2', 'homework1_desc', TIMESTAMP '2011-05-16 15:36:38', '{1,2,3,4}', '{}');
INSERT INTO homeworks (name, description, deadline, problems, records) VALUES ('homework3', 'homework1_desc', TIMESTAMP '2011-05-16 15:36:38', '{3,4,5}', '{}');
INSERT INTO homeworks (name, description, deadline, problems, records) VALUES ('homework4', 'homework1_desc', TIMESTAMP '2011-05-16 15:36:38', '{6,7,8}', '{}');


INSERT INTO courses (name, description, TAs, students, status, homeworks, notices) VALUES ('software', 'xxxxxxxxxxxx', '{2}', '{1}', 1, '{1,2,3,4}', '{1,2,3}');
