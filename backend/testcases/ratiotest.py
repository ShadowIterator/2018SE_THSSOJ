...
class RatioTest(BaseTestCase):
    async def prepare(self):
        self.url = '/api/ratio'
        self.user1 = await self.createUser('users', username = 'hfz', password = 'hfz', email = 'hfz@hfz.com', role = 1)
        self.user2 = await self.createUser('users', username = 'hfz1', password = 'hfz', email = 'hfz@hfz.com', role = 1)
