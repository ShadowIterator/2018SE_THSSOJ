...
class APIProblemHandler(base.BaseHandler):
    ...
    async def _submit_post(self):
        ...
        if ('homework_id' in self.args.keys()):
            ...
            hash_id = self.args['problem_id'] * 1234567891 + cur_user['id']
        async with self.db.get_lock_object('global', hash_id):
            ...
            if self.args['record_type'] == 4:
                ...
                if len(old_record) == 0:
                    ...
                    await self.db.saveObject('problems', object=problem_of_code,
                ...
                stu_homework_path = self.root_dir.replace('problems', 'homeworks') + '/' + str(
                    self.args['homework_id']) + \
